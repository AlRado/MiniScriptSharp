namespace Miniscript.intrinsic {
    ...
    public class Consts {
        ...
        public const string BIT_AND = "bitAnd";
        public const string BIT_OR = "bitOr";
        public const string BIT_XOR = "bitXor";
        public const string CHAR = "char";
        public const string CEIL = "ceil";
        public const string CODE = "code";
        public const string COS = "cos";
        public const string FLOOR = "floor";
        public const string FUNC_REF = "funcRef";
        public const string HASH = "hash";
        public const string HAS_INDEX = "hasIndex";
